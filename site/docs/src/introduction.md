...
- **Sidebar Filters, Playlists + Analyze All** — browse artists, albums, and existing folder/Plex/Jellyfin/Navidrome playlists, then batch-analyze the current selection or enable auto-analysis after scans
